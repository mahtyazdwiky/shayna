            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="photo_utama" />
                </div>
                <div class="product-thumbs">
                  <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                    <div
                      ...
                      :class="thumbs[0] == photo_utama ? 'active' : '' "
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == photo_utama ? 'active' : '' "
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == photo_utama ? 'active' : '' "
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == photo_utama ? 'active' : '' "
                    >
